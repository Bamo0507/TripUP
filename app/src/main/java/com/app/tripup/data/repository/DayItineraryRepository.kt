...
class DayItineraryRepository(private val dayItineraryDao: DayItineraryDao) {
    suspend fun insertDayItinerary(dayItinerary: DayItinerary) = dayItineraryDao.insertDayItinerary(dayItinerary)
    suspend fun getDaysForItinerary(itineraryId: Int): List<DayItinerary> = dayItineraryDao.getDaysForItinerary(itineraryId)
